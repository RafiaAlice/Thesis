%--Bagging based on Naive Bayes(5 models)(testing using 1/3 data)--%
%------------------------------------------------------------------%
...
for k=1:5
    ...
    test_features(index_row,:)=[];% For 1/3 Test
...
ff(k).att=res;
accu=TP_TN*100/2708;
sprintf('Accuracy of Model-%.15g : %.5g ',k,accu)
miss_classify=2708-TP_TN;
